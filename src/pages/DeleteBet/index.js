      ...
      <PageContainer>
        ...
        <PageArea>
          <div className={styles.textInfo}>
            ...
            <p>
              Ao realizar essa ação esse ticket não é valido para o jogo,
              se realmente deseja remover esse ticket, digite o identificador
              da aposta e aperte no botão deletar
            </p>
          </div>
          <div className={styles.formSubmit}>
            <input onChange={handleChangeInput} placeholder="Nome do ticket aqui !!"/>
